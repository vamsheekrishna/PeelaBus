...
import peelabus.com.authentication.LoginFragment;
import peelabus.com.baseclasses.NetworkBaseFragment;

public class BusTrackingFragment extends NetworkBaseFragment implements OnMapReadyCallback {

    private static final int LOCATION_PERMISSION_REQUEST_CODE = 1;

    private GoogleMap mMap;
    OnTrackMyBusInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnTrackMyBusInteractionListener) {
            mListener = (OnTrackMyBusInteractionListener) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement OnTrackMyBusInteractionListener");
        }
    }
    ...
    private void showDefaultLocation() {
        Toast.makeText(getActivity(), "Location permission not granted, " + "showing default location", Toast.LENGTH_SHORT).show();
